public class ChatBot {
    ...
    // my methods:
    public double averageNumbers(int num1, int num2, int num3) {
        return addNumbers(num1,num2,num3)/3.0;
    }

    public void printAverageNumbers(int num1, int num2, int num3) {
        System.out.println("The average is " + averageNumbers(num1,num2,num3));
    }
}